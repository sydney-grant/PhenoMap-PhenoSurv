...
path_train = pd.read_csv("~//Documents//Survival VAE//brain_top_predicted_0.25_IMPACT.csv")
survival = pd.read_csv("~//Documents//Survival VAE//brain_clin_top_0.25_IMPACT.csv")
filtered_survival = survival.dropna(subset=['PFS_MONTHS', 'PFS_STATUS'])
...
filtered_survival = filtered_survival[['PatientID', 'PFS_STATUS', 'PFS_MONTHS']]
filtered_survival = filtered_survival.rename(columns={'PatientID':'PatientID','PFS_STATUS':'Status', 'PFS_MONTHS':'Survival_in_days'})
...
path_y_train.loc[path_y_train['Status'] == '0:CENSORED', 'Status'] = 0
path_y_train.loc[path_y_train['Status'] == '1:PROGRESSION', 'Status'] = 1
...
df.to_csv('~//Documents//Survival VAE//FINAL PHENOSURV//pathways_trainingloop_Adam_LeakyReLU_brain_PC_FINAL.csv', index=False)
