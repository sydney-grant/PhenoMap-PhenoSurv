...
path_val = pd.read_csv("~//Documents//Survival VAE//Validation Data//Breast_MSK_Scores_IMPACT_hrpos.csv")
...
df.to_csv('~//Documents//Survival VAE//FINAL PHENOSURV//pathways_trainingloop_Adam_LeakyReLU_breast_MSK_hrpos_FINAL.csv', index=False)
