...
path_val = pd.read_csv("~//Documents//Survival VAE//Validation Data//Lung_MSK_Scores_IMPACT.csv")
path_val = path_val.dropna(subset=['RFS_MONTHS', 'RFS_STATUS'])
path_x_val = path_val.drop(columns = ['Unnamed: 0','PatientID', 'RFS_MONTHS', 'RFS_STATUS', 'OS_MONTHS', 'OS_STATUS'])
path_y_val = path_val[['RFS_STATUS', 'RFS_MONTHS']]
path_y_val = path_y_val.rename(columns={'RFS_STATUS':'Status', 'RFS_MONTHS':'Survival_in_days'})
...
df.to_csv('~//Documents//Survival VAE//FINAL PHENOSURV//pathways_trainingloop_Adam_LeakyReLU_lung_MSK_FINAL.csv', index=False)
