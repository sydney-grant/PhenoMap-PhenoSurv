...
path_train = pd.read_csv("~//Documents//Survival VAE//breast_top_predicted_0.25_IMPACT_hrpos.csv")
survival = pd.read_csv("~//Documents//Survival VAE//breast_clin_top_0.25_IMPACT_hrpos.csv")
...
df.to_csv('~//Documents//Survival VAE//FINAL PHENOSURV//pathways_trainingloop_Adam_LeakyReLU_breast_hrpos_FINAL.csv', index=False)
