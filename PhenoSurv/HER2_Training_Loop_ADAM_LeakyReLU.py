...
path_train = pd.read_csv("~//Documents//Survival VAE//breast_top_predicted_0.25_IMPACT_her2.csv")
survival = pd.read_csv("~//Documents//Survival VAE//breast_clin_top_0.25_IMPACT_her2.csv")
...
for wd in [0, 0.0001, 0.001]:
    for batch_size in [8, 16, 32]:
        for epochs in [50, 100, 1000, 2000, 5000]:
...
df.to_csv('~//Documents//Survival VAE//FINAL PHENOSURV//pathways_trainingloop_Adam_LeakyReLU_breast_her2_FINAL.csv', index=False)
