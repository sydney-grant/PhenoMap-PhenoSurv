...
pathways <- read.csv("GSVA_Results_PANCAN_Hallmark.csv")


genes_pathways_hallmark <- read.csv(paste0("hallmark_genefilter_", split_num, "_IMPACT.csv"))[,-1]
...
print("Saving data...")
write.csv(train_preds, paste0("train_predictions_FINAL_", split_num, "_hallmark_IMPACT.csv"))
write.csv(test_preds, paste0("test_predictions_FINAL_", split_num, "_hallmark_IMPACT.csv"))
#saveRDS(model_list, "hallmark_trained_models_IMPACT.rds")
