...
genes_pathways_hallmark <- read.csv(paste0("reactome_genefilter_", split_num, "IMPACT.csv"))[,-1]
...
print("Saving data...")
write.csv(train_preds, paste0("train_predictions_FINAL_", split_num, "_", start, "_", stop, "_reactome_IMPACT.csv"))
write.csv(test_preds, paste0("test_predictions_FINAL_", split_num,  "_", start, "_", stop, "_reactome_IMPACT.csv"))
#saveRDS(model_list, paste0("reactome_trained_models_", start, "_", stop, "IMPACT.rds"))
